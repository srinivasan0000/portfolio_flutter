...
class Waterfall extends ParticleFX {
  ...
  Waterfall({required SpriteSheet spriteSheet, required Size size}) : super(spriteSheet: spriteSheet, size: size, count: size.shortestSide > 600 ? 40000 : 20000);
  ...
  void tick(Duration duration) {
    ...
    for (int i = 0; i < count; i++) {
      ...
      if (touchPoint != null && (dy = touchPoint!.dy - o.y) < maxD && (dx = touchPoint!.dx - o.x) < maxD && (d = sqrt(dx * dx + dy * dy)) < maxD) {
